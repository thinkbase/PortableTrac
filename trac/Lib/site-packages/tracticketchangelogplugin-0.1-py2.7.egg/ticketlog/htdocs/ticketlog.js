$(document).ready(function() {
    ...
    var onQueryError = function(msg){
        var error_html = "<table class='listing'><tbody><tr style='background-color: yellow;'><td>Error in querying changelogs.</td><tr></tbody></table>";
    ...
    var waiting_html_id = "ticketlog_waiting_" + (new Date()).getTime();
    var waiting_html = "<table class='listing' id='"+waiting_html_id+"'><tbody><tr style='background-color:#FFFF99;'><td><img width='16px' height='16px' border='0' align='middle' src='../chrome/ticketlog/indicator.gif'/> Querying changelogs ...</td><tr></tbody></table>";
    $("#ticket").after(waiting_html);
